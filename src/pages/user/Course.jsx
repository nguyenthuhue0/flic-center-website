        ...
        {["LẬP TRÌNH", "TOEIC", "TIN HỌC"].map((tab) => (
          <div
            ...
            className={`cursor-pointer pb-1 font-bold px-3 text-[32px] ${
              selectedTab === tab ? "text-red-600 border-b-4 border-red-600" : "text-gray-800 hover:text-red-500"
            }`}
          >
            {tab}
          </div>
      ...
      <div className="w-full flex justify-center">
        <div className="flex flex-wrap justify-center gap-x-10 gap-y-8 max-w-[1120px]">
          {allCourses[selectedTab].map((course, idx) => (
            ...
            >
              {/* Phần ảnh */}
              <div className={`w-full h-[200px] flex items-center justify-center text-white text-base font-semibold ${colors[idx % colors.length]}`}>
                Ảnh
              </div>
              ...
              <div className="bg-white p-4 flex-1 flex flex-col justify-between rounded-b-2xl">
                <div>
                  <h2 style={{ fontSize: '24px' }} className="font-semibold text-gray-900 flex items-center gap-2">
                    <span className="text-blue-600">📘</span>
                    {course.title}
                  </h2>
                  <p style={{ fontSize: '14px' }} className="text-blue-500 font-medium mb-2 pl-[42px]">Đào tạo 3 tháng</p>
                </div>
                ...
                <div className="text-sm text-gray-700 mt-auto">
                  <div className="flex justify-between items-center mt-2">
                    <div className="font-bold pl-[8px]">
                      Khai giảng : <span className="font-bold">{course.date}</span>
                    </div>
                    <button
...
/>
      ...
      <div className="flex justify-center items-center gap-4 my-10 text-lg font-medium select-none">
        ...
        <button className="bg-red-500 text-white w-7 h-7 rounded hover:bg-red-600 transition-all">1</button>
