            ...
            <div className="max-w-4xl mx-auto space-y-10">
                ...
                <section className="bg-white rounded-xl shadow-md p-6 md:flex md:justify-between gap-6">
                    ...
                    <div className="md:w-1/2 text-center mt-6 md:mt-0">
                        ...
                        <img
                            src="https://lh7-rt.googleusercontent.com/formsz/AN7BsVCLX7d9jOVDSyVXtTkiTEhU2Fj1HJLwr7kClmXWYkWRULp1uNOO6rd0sHBo-H81hfQdLNrYNX3e0FkTfIoMu__ayyumUprJdRSHeyYB_mQNRk8ZYLr6Ij5WjBioooVtVLxqAeYxmVrpKwj6u0iqLJIXqQ=w710?key=Jwr_a9ZIMqDHM9MR2aw2vw"
                            alt="QR Code"
