    ...
    <div className="min-h-screen bg-gray-50 flex">
      <main className="flex-1 p-6 flex flex-col items-center justify-start">
        <div className="max-w-2xl w-full">
          <h1 className="text-2xl font-bold text-center mb-6 text-red-600">Upload Lesson Material</h1>
          ...
          <div className="bg-white border-2 border-blue-200 rounded-lg p-6 space-y-4 shadow-sm">
            ...
            <div>
              ...
              {selectedFile && !uploading && (
                <p className="text-sm text-gray-700">File đã chọn: {selectedFile.name}</p>
              )}
            </div>
