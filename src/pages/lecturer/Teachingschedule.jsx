  ...
  return (
    <div className="p-6 min-h-screen ">
      ...
      <div
        ...
        onClick={() => navigate("../MaterialsDashboard")}
      >
        📘 Lịch giảng dạy chi tiết
      </div>

      {/* Header bảng */}
      <div className="grid grid-cols-5 bg-[#D52929] h-[50px] text-[17px] text-white font-semibold px-4 py-2 mt-6 ">
        <div>STT</div>
        <div>Tên lớp</div>
        <div>Suất học</div>
        <div>Thời gian</div>
      ...
      <div className="space-y-4 mt-3">
        {data.map((i) => (
          <div
            key={i}
            className="grid grid-cols-5 bg-white text-[17px] px-4 py-3 border border-gray-300 rounded shadow-sm h-[50px] items-center"
          >
